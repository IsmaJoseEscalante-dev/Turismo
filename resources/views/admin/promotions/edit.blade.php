                ...
                <form action="{{ route('promotions.update', $promotion->id) }}" method="POST" enctype='multipart/form-data'>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 form-group">
                            ...
                            <input id="slug" name="slug" type="text" value="{{ old('slug', $promotion->slug) }}"
                                   class="form-control"
                                   readonly>
                            @error('slug')
                            <span class="invalid-feedback d-block" role="alert">
                    ...
                    <div class="row">
                        <div class="col-md-6 form-group">
                            ...
                            <select class="form-control select2 {{ $errors->has('tours') ? 'is-invalid' : '' }}"
                                ...
                                @foreach ($tours as $id => $tour)
                                    <option value="{{ $id }}"
                                        {{ (in_array($id, old('tours', [])) || $promotion->tours->contains($id)) ? 'selected' : '' }}>
                        ...
                        <div class="col-md-6 form-group">
                            ...
                            <input id="amount" name="amount" value="{{ old('amount',$promotion->amount) }}"
                                   type="number"
                                   class="form-control">
                            @error('amount')
                            <span class="invalid-feedback d-block" role="alert">
                    ...
                    <div class="row">
                        <div class="col-md-6 form-group">
                            ...
                            <input class="form-control" type="date" name="date_start"
                                   value="{{ old('date_start', $promotion->date_start) }}">
                        </div>
                        <div class="col-md-6 form-group">
                            <label>Fecha de Fin</label>
                            <input class="form-control" type="date" name="date_finish"
                                   value="{{ old('date_finish',$promotion->date_finish) }}">
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 form-group">
                            ...
                            <input name="discount" value="{{ old('discount', $promotion->discount) }}" type="number"
                                   class="form-control">
                            @error('discount')
                            <span class="invalid-feedback d-block" role="alert">
                                <strong>{{ $message }}</strong>
                    ...
                    <a href="{{ route('promotions.index') }}" class="btn btn-secondary" tabindex="5">Cancelar</a>
